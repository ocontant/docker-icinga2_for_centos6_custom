...
#
# This CentOS6 Docker-icinga2 is based the official CentOS7 based Docker-icinga2
# 
# Difference:
#  Install EPEL repository for CentOS6
#  Install icinga repository for CentOS6
#  Expose Nagios plugins volumes from /usr/lib64/nagios/plugins directory
#  Changed the nodename to icinga2 instead of docker-icinga2
#
# ******************************************************************************
FROM centos:centos6

MAINTAINER Olivier Contant
...
RUN sed -i -e 's/^.* NodeName = .*/const NodeName = "icinga2"/gi' /etc/icinga2/constants.conf; \
